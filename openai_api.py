...
functions = [
    {
        ...
        "description": "Получить прогноз погоды на текущее время. При вызови этой функции автоматически определяется геолокация пользователя. Не нужно спрашивать пользователя его геолокацию",
