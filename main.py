...
async def location_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    if update.message.location:
        ...
        await handle_message_inner(update, context, "Получена новая системная информация, внимательно проанализируйте историю и постарайтесь ответить на вопрос или вызови следующую функцию, необходимую для ответа на вопрос.")
